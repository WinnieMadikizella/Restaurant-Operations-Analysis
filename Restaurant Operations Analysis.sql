...
SELECT * FROM menu_items
ORDER BY price;
/* the least expensive item is Edamame at 5.00 while the most expensive item is Shrimp Scampi 
at 19.95 */
...
WHERE category = 'Italian'
ORDER BY price;
/* the least expensive Italian dish on the menu is Spaghetti at 14.50 and the most expensive
is Shrimp Scampi at 19.95 */
...
/* the least ordered item was Chicken Tacos and the most ordered item was Hamburger */
